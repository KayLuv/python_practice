...
APP_KEY = '2205560309' # app key
APP_SECRET = 'a53ef95176d538358658ed19a79b1e15' # app secret
CALLBACK_URL = 'https://api.weibo.com/oauth2/default.html' # callback url
AUTH_URL = 'https://api.weibo.com/oauth2/authorize'
USERID = 'jsjhlk@163.com' # userid
PASSWD = '19951108520a' #password

def main():
    """获取用户第一条评论,当第一条微博改变时,进行命令执行,并在微博评论处返回执行信息"""

    c = APIClient(APP_KEY, APP_SECRET, CALLBACK_URL, username=USERID, password=PASSWD)
